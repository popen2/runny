...
angular.module('runny.admin', ['runny.ui_helpers']);

angular.module('runny.admin').provider('adminView', function(viewPath) {
    return {
        $get: function() {
            return function(uri) {
...
angular.module('runny.admin').provider('adminUrlRoutes', function(adminViewProvider) {
...
angular.module('runny.admin').config(function(urlRegisterProvider, adminUrlRoutesProvider) {
    urlRegisterProvider.$get()(adminUrlRoutesProvider.$get());
});

angular.module('runny.admin').controller('AdminController', function($scope, $location, curUser) {
...
angular.module('runny.admin').controller('UsersAdminController', function($scope, $stateParams, createNewUser) {
    $scope.selected_user_id = $stateParams.id;
    $scope.createNewUser = createNewUser;
});

angular.module('runny.admin').controller('AuthenticationAdminController', function($scope) {
});

angular.module('runny.admin').service('createNewUser', function($uibModal, adminView) {
    return function() {
        $uibModal.open({
...
angular.module('runny.admin').controller('CreateNewUserController', function($scope, $controller, $http, $uibModalInstance) {
...
angular.module('runny.admin').controller('LocalAuthBackendController', function($scope, users, createNewUser) {
    $scope.users = users;
    $scope.createNewUser = createNewUser;
});

angular.module('runny.admin').controller('GoogleLoginAdminController', function($scope, $http, siteUrl) {
...
angular.module('runny.admin').controller('LDAPLoginAdminController', function($scope, $http) {
    $scope.working = true;
