...
angular.module('runny.ui_helpers', [
    'ui.router',
...
angular.module('runny.ui_helpers').config(function($numeraljsConfigProvider) {
    $numeraljsConfigProvider.setFormat('capacity', '0,0.00 b');
});

angular.module('runny.ui_helpers').run(function($rootScope, $state) {
    $rootScope.moment = moment;
    $rootScope.$state = $state;
    $rootScope.number = parseFloat;
});

angular.module('runny.ui_helpers').constant('viewPath', function(uri) {
    return '/inline/' + uri;
});

angular.module('runny.ui_helpers').provider('urlRegister', function($urlRouterProvider, stateHelperProvider) {
...
angular.module('runny.ui_helpers').directive('focusMe', function() {
...
angular.module('runny.ui_helpers').filter('titlecase', function() {
    return function(s) {
...
angular.module('runny.ui_helpers').filter('isEmpty', function() {
    return _is_empty;
});

angular.module('runny.ui_helpers').filter('isNotEmpty', function() {
    return function(o) {
        return !_is_empty(o);
    };
});

angular.module('runny.ui_helpers').directive('preventDefault', function() {
...
angular.module('runny.ui_helpers').controller('ModalBase', function($scope, $uibModalInstance) {
...
angular.module('runny.ui_helpers').directive('whErrorBox', function() {
    return {
        restrict: 'E',
...
angular.module('runny.ui_helpers').filter('count', function() {
    return function(o) {
        if (o === undefined || o === null) {
            return 0;
        }
